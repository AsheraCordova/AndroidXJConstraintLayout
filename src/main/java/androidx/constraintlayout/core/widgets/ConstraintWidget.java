...
public class ConstraintWidget {
    ...
    public @com.google.j2objc.annotations.Weak ConstraintWidget mParent = null;
    ...
    private void applyConstraints(LinearSystem system, boolean isHorizontal,
                                  ...
                                  boolean isTerminal, SolverVariable parentMin, SolverVariable parentMax,
        ...
        if (!isBeginConnected && !isEndConnected && !isCenterConnected) {
            ...
            if (parentWrapContent && beginWidget instanceof CoreBarrier) {
            ...
            if (variableSize) {
                if (matchConstraintDefault == MATCH_CONSTRAINT_SPREAD) {
                    ...
                    if (beginWidget instanceof CoreBarrier || endWidget instanceof CoreBarrier) {
                    ...
                    if (mResolvedDimensionRatioSide == UNKNOWN) {
                        ...
                        if (useRatio) {
                            ...
                            boolean otherSideInvariable = oppositeMatchConstraintDefault == MATCH_CONSTRAINT_PERCENT
            ...
            if (parentWrapContent && inBarrier // if we are referenced by a barrier
                    && !(beginWidget instanceof CoreBarrier || endWidget instanceof CoreBarrier)
                    && !(endWidget == parent)) {
            ...
            if (applyBoundsCheck) {
                if (applyStrongChecks && (!oppositeInChain || oppositeParentWrapContent)) {
                    ...
                    if (beginWidget instanceof CoreGuideline || endWidget instanceof CoreGuideline) {
    ...
    public void copy(ConstraintWidget src, HashMap<ConstraintWidget, ConstraintWidget> map) {
        ...
        mHorizontalNextWidget = (src.mHorizontalNextWidget == null) ? null : map.get(src.mHorizontalNextWidget);
        mVerticalNextWidget = (src.mVerticalNextWidget == null) ? null : map.get(src.mVerticalNextWidget);
    }
