...
public class ConstraintAnchor {
   ...
   /**
    ...
    public @com.google.j2objc.annotations.Weak final ConstraintWidget mOwner;
    public final Type mType;
    public @com.google.j2objc.annotations.Weak ConstraintAnchor mTarget;
    ...
    public boolean isValidConnection(ConstraintAnchor anchor) {
        ...
        switch (mType) {
            ...
            case RIGHT: {
                ...
                if (anchor.getOwner() instanceof CoreGuideline) {
