...
import androidx.constraintlayout.core.widgets.CoreVirtualLayout;
...
public class BasicMeasure {
    ...
    @com.google.j2objc.annotations.Weak private ConstraintWidgetContainer constraintWidgetContainer;
    ...
    public long solverMeasure(ConstraintWidgetContainer layout,
        ...
        if (optimize) {
            for (int i = 0; i < childCount; i++) {
                ...
                if (child instanceof CoreVirtualLayout) {
                    optimize = false;
                    break;
                }
        ...
        if (!allSolved || computations != 2) {
            ...
            if (sizeDependentWidgetsCount > 0) {
                ...
                for (int i = 0; i < sizeDependentWidgetsCount; i++) {
                    ...
                    CoreVirtualLayout virtualLayout = (CoreVirtualLayout) widget;
                ...
                for (int j = 0; j < maxIterations; j++) {
                    for (int i = 0; i < sizeDependentWidgetsCount; i++) {
                        ConstraintWidget widget = mVariableDimensionsWidgets.get(i);
                        if ((widget instanceof Helper && !(widget instanceof CoreVirtualLayout)) || widget instanceof CoreGuideline) {
                            continue;
                        }
