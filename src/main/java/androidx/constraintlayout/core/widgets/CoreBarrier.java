 ...
 */
public class CoreBarrier extends HelperWidget {
    ...
    public CoreBarrier() {}
    public CoreBarrier(String debugName) {
    ...
    public void copy(ConstraintWidget src, HashMap<ConstraintWidget,ConstraintWidget> map) {
        super.copy(src, map);
        CoreBarrier srcBarrier = (CoreBarrier) src;
    ...
    public void addToSolver(LinearSystem system, boolean optimize) {
        ...
        for (int i = 0; i < mWidgetsCount; i++) {
            ...
            if (USE_RELAX_GONE) {
                if (widget.getVisibility() != GONE || widget instanceof CoreGuideline || widget instanceof CoreBarrier) {
