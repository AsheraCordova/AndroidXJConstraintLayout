...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    @com.google.j2objc.annotations.Weak private final ArrayRow mRow; // our owner
    @com.google.j2objc.annotations.Weak protected final Cache mCache; // pointer to the system-wide cache, allowing access to SolverVariables
