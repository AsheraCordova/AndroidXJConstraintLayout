 ...
 * @hide
 */
public class CLCustomAttribute {
     ...
     * @return
     */
    public boolean diff(CLCustomAttribute CustomAttribute) {
    ...
    public CLCustomAttribute(String name, AttributeType attributeType) {
        mName = name;
        mType = attributeType;
    }

    public CLCustomAttribute(String name, AttributeType attributeType, Object value, boolean method) {
        mName = name;
        mType = attributeType;
        mMethod = method;
        setValue(value);
    ...
    public CLCustomAttribute(CLCustomAttribute source, Object value) {
        mName = source.mName;
        mType = source.mType;
        setValue(value);
    ...
    public static HashMap<String, CLCustomAttribute> extractAttributes(
            HashMap<String, CLCustomAttribute> base, Object view) {
        HashMap<String, CLCustomAttribute> ret = new HashMap<>();
        Class<? extends Object> viewClass = view.getClass();
        for (String name : base.keySet()) {
            CLCustomAttribute CustomAttribute = base.get(name);

            try {

                Method method = viewClass.getMethod("getMap" + name);
                Object val = method.invoke(view);
                ret.put(name, new CLCustomAttribute(CustomAttribute, val));
    ...
    public static void setAttributes(Object view, HashMap<String, CLCustomAttribute> map) {
        Class<? extends Object> viewClass = view.getClass();
        for (String name : map.keySet()) {
            CLCustomAttribute CustomAttribute = map.get(name);
