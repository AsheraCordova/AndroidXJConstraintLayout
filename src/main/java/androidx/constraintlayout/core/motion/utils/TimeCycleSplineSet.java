...
import androidx.constraintlayout.core.motion.CLCustomAttribute;
    ...
    public static class CustomSet extends TimeCycleSplineSet {
        ...
        public void setup(int curveType) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                CLCustomAttribute ca = mConstraintAttributeList.valueAt(i);
        ...
        public void setPoint(int position, CLCustomAttribute value, float period, int shape, float offset) {
